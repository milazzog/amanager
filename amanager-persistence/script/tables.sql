...
ALTER TABLE EXPENSE_NOTE
  ADD CREATED_AT TIMESTAMP NOT NULL
  AFTER CREDIT_NOTE;

CREATE TABLE PRODUCT_PART_REGISTRY (
  ID         BIGINT    NOT NULL PRIMARY KEY AUTO_INCREMENT,
  PRODUCT    BIGINT    NOT NULL,
  ADDED_AT   TIMESTAMP NOT NULL,
  REMOVED_AT TIMESTAMP NULL                 DEFAULT NULL,
  CONSTRAINT FK_PRODUCT_PART_REGISTRY_PRODUCT FOREIGN KEY (PRODUCT) REFERENCES PRODUCT (ID)
)
  COLLATE = 'utf8_general_ci'
  ENGINE = InnoDB;

ALTER TABLE PRODUCT
  ADD PRODUCT_PART_REGISTRY BIGINT DEFAULT NULL
  AFTER NAME;
ALTER TABLE PRODUCT
  ADD CONSTRAINT FK_PRODUCT_PRODUCT_PART_REGISTRY FOREIGN KEY (PRODUCT_PART_REGISTRY) REFERENCES PRODUCT_PART_REGISTRY (ID);

ALTER TABLE PRODUCT_PART
  ADD PRODUCT_PART_REGISTRY BIGINT NOT NULL
  AFTER PRODUCT;
ALTER TABLE PRODUCT_PART
  ADD CONSTRAINT FK_PRODUCT_PART_PRODUCT_PART_REGISTRY FOREIGN KEY (PRODUCT_PART_REGISTRY) REFERENCES PRODUCT_PART_REGISTRY (ID);

ALTER TABLE PRODUCT_PART
  DROP FOREIGN KEY FK_PRODUCT_PART_PRODUCT;
ALTER TABLE PRODUCT_PART
  DROP COLUMN PRODUCT
